...
from raksha.openstack.common import exception as common_exception
from raksha.openstack.common import importutils
from raksha.openstack.common import log as logging
import raksha.policy
...
class ExtensionManager(object):
    ...
    See raksha/tests/api/extensions/foxinsocks/extension.py for an
    ...
    def _load_extensions(self):
        ...
        old_contrib_path = ('raksha.api.openstack.volume.contrib.'
                            'standard_extensions')
        new_contrib_path = 'raksha.api.contrib.standard_extensions'
        if old_contrib_path in extensions:
            LOG.warn(_('osapi_dpaas_extension is set to deprecated path: %s'),
                     old_contrib_path)
            LOG.warn(_('Please set your flag or raksha.conf settings for '
                       'osapi_dpaas_extension to: %s'), new_contrib_path)
...
class ControllerExtension(object):
    """Extend core controllers of raksha OpenStack API.

    Provide a way to extend existing raksha OpenStack API core
    controllers.
    """
...
class ResourceExtension(object):
    """Add top level resources to the OpenStack API in raksha."""
...
def extension_authorizer(api_name, extension_name):
    def authorize(context, target=None):
        ...
        raksha.policy.enforce(context, action, target)
    return authorize
