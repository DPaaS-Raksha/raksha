...
XMLNS_V1 = 'http://docs.openstack.org/raksha/api/v1'
...
_CONTENT_TYPE_MAP = {
    'application/vnd.openstack.raksha+json': 'application/json',
    'application/vnd.openstack.raksha+xml': 'application/xml',
}

SUPPORTED_CONTENT_TYPES = (
    'application/json',
    'application/vnd.openstack.raksha+json',
    'application/xml',
    'application/vnd.openstack.raksha+xml',
)

_MEDIA_TYPE_MAP = {
    'application/vnd.openstack.raksha+json': 'json',
    'application/json': 'json',
    'application/vnd.openstack.raksha+xml': 'xml',
    'application/xml': 'xml',
...
class Request(webob.Request):
    ...
    def best_match_content_type(self):
        ...
        if 'raksha.best_content_type' not in self.environ:
            ...
            self.environ['raksha.best_content_type'] = (content_type or
                                                        'application/json')

        return self.environ['raksha.best_content_type']
...
class Resource(wsgi.Application):
    ...
    def _process_stack(self, request, action, action_args,
        ...
        context = request.environ.get('raksha.context')
...
def _set_request_id_header(req, headers):
    context = req.environ.get('raksha.context')
    if context:
