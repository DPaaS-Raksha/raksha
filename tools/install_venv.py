...
def print_help():
    help = """
    Raksha development environment setup is complete.

    Raksha development uses virtualenv to track and manage Python
    dependencies while in development and testing.

    To activate the Raksha virtualenv for the extent of your
