# -*- coding: utf-8 -*-
#
# raksha documentation build configuration file, created by
...
# built documents.
#
from raksha.version import version_info
...
man_pages = [
    ('man/raksha-manage', 'raksha-manage', u'Cloud controller fabric',
     [u'OpenStack'], 1)
]
...
# [howto/manual]).
latex_documents = [
    ('index', 'Raksha.tex', u'Raksha Documentation',
